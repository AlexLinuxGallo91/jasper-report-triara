...
public class ArgumentDestinationBean {
	...
	public ArgumentDestinationBean(String driver, String localhost, String port, String databaseName, String username,
			String password, String jasperFilePath, String destinationPathReport) {
		super();
		this.driver = driver;
	...
	public String toString() {
		String beanString = String.format(
				...
				this.driver, this.localhost, this.port, this.databaseName, this.username, this.password,
				this.jasperFilePath, this.destinationPathReport);
